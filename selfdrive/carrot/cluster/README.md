...
`ClusterHudTheme`: dark uses `30%` and light uses `80%`. Theme mode `0` keeps
...
Detected vehicle markers use a smooth rounded vehicle-like blob instead of a
plain cube, and vehicle ground shadows are not drawn.
